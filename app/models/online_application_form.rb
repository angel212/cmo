class OnlineApplicationForm < ActiveRecord::Base
  attr_accessible :composite_updated_at, :education_detail_id, :employment_detail_id, :personal_detail_id, :preference_id, :supporting_document_id, :user_id, :status , :password
