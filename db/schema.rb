...
ActiveRecord::Schema.define(:version => 20140925020733) do
  ...
  create_table "education_schools", :force => true do |t|
    t.integer  "online_application_form_id"
    t.string   "school"
    t.string   "location"
  ...
  create_table "function_experiences", :force => true do |t|
    t.integer  "online_application_form_id"
    t.string   "function"
  ...
  create_table "geographic_experiences", :force => true do |t|
    t.integer  "online_application_form_id"
    t.string   "continent"
    t.string   "country"
    t.datetime "created_at",                 :null => false
